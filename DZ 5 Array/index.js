...
const multiplicationTable2 = multiplicationTable5
console.log(multiplicationTable2);

// Deep Copy

const multiplicationTable3 = multiplicationTable5.slice();
...
const resArray = [rest1, rest2, rest3, rest4].flat(1).filter(element => element !== 0);;
